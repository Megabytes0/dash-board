                ...
                <main>
                                            ...
                                            <div class="card-body">
                                                <form action="" method="POST">
                                                    <div class="row mb-6">
                                                        ...
                                                        <div class="form-floating mb-3 p-1">
                                                            <input class="form-control" name="position" id="inputPosition" type="text" placeholder="Position" />
                                                            <label for="inputPosition">Position</label>
                                                        </div>
                                                        <div class="form-floating mb-3 p-1">
                                                            <input class="form-control" name="office" id="inputOffice" type="text" placeholder=" Office" />
                                                            <label for="inputOffice">Office</label>
                                                        </div>
                                                        <div class="form-floating mb-3 p-1">
                                                            <input class="form-control" name="age" id="inputAge" type="number" placeholder="Age" />
                                                            <label for="inputEmail">Age</label>
                                                        </div>
                                                        <div class="form-floating mb-3 p-1">
                                                            <input class="form-control" name="start_work" id="inputStartdate" type="date" placeholder="Start date" />
                                                            <label for="inputStartdate">Start date</label>
                                                        </div>
                                                        <div class="form-floating mb-3 p-1">
                                                            <input class="form-control" name="salary" id="inputSalary" type="decimal" placeholder="Salary" />
                    ...
                    if ($query) {
                        while ($rows = mysqli_fetch_assoc($query)) {
                            ...
                            echo '<a href="edit.php" type="button" value="' . $rows['user_id'] . '" class="btn btn-primary" name="edit">Edit</a>';
